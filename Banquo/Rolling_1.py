...
M1pwm = 12   # PWM for Motor 1 (orange wire)
M2pwm = 18   # PWM for Motor 2 (yellow wire)
M3pwm = 13   # PWM for Motor 3 (green wire)
M4pwm = 19   # PWM for Motor 4 (blue wire)
